...
export default function SeoTags() {
  ...
  useEffect(() => {
    if (pathname === "/") {
      ...
      setDescription(
        "CapoBiz POS offers top retail software to streamline sales, inventory, and customer management. Optimize your retail business with our advanced POS solutions."
      );
      ...
      setDescription(
        "Learn about CapoBiz POS, a leader in retail software innovation. Our mission is to empower businesses with cutting-edge POS systems"
      );
      ...
      setDescription(
        "A best POS system for restaurant management serves as the backbone of a successful restaurant business, offering a centralized platform to streamline operations."
      );
    }
    else {
      setName("Home");
